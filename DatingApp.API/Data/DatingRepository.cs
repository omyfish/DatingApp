...
namespace DatingApp.API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        {
            return await _context.Users.Include(p => p.Photos).FirstOrDefaultAsync(_ => _.Id == id);
        }
        ...
        {
            return await _context.Photos.FirstOrDefaultAsync(_ => _.Id == id);
        }

        public async Task<Photo> GetMainPhotoForUser(int userId)
        {
            return await _context.Photos.Where(_ => _.UserId == userId).FirstOrDefaultAsync(x => x.IsMain);
        }
        ...
        {
             return await _context.Messages.FirstOrDefaultAsync(l => l.Id == id);
        }
        ...
        public async Task<PagedList<Message>> GetMessageForUser(MessageParams messageParams)
        {
           ...
           if (!string.IsNullOrEmpty(messageParams.MessageContainer)) {
